                                    ...
                                    <div class="widget__inner">
                                        <div class="menu-footer-widgets-menu-1-container">
                                            <ul id="menu-footer-widgets-menu-1" class="menu">
                                                <li id="menu-item-312" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-312 <?php echo e(request()->routeIs('family.members') ? 'current-menu-item' : ''); ?>"><a href="<?php echo e(route('family.members')); ?>">أفراد العائلة</a></li>
                                                <li id="menu-item-314" class="menu-item menu-item-type-post_type menu-item-object-lsvr_family_member <?php echo e(request()->routeIs('family.member') ? 'current-menu-item' : ''); ?> menu-item-314"><a href="<?php echo e(route('family.member', ['id' => 1])); ?>" aria-current="page">شجرة العائلة</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="footer-collage__inner">
                <div class="footer-collage__grid">
                    ...
                    <div class="footer-collage__grid-item">
                        ...
                        <a href="<?php echo e(route('family.member', ['id' => $person->id])); ?>" class="footer-collage__grid-item-link footer-collage__grid-item-link--loading" title="<?php echo e($person->name); ?>" style="background-image: url( <?php echo e($person->photo ? asset($person->photo) : asset('template/app-assets/images/portrait/medium/avatar-m-1.png')); ?> )">
                            <img src="<?php echo e($person->photo ? asset($person->photo) : asset('template/app-assets/images/portrait/medium/avatar-m-1.png')); ?>" class="footer-collage__grid-item-image" alt="<?php echo e($person->name); ?>">
                        </a>
...
<!-- FOOTER : end --><?php /**PATH C:\laragon\www\family-tree\resources\views/frontend/layout/partials/footer.blade.php ENDPATH**/ ?>