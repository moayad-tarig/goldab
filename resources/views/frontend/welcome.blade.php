<x-front-layout class="core--fullwidth">
    <x-slot name="header">
                    ...
                    <div class="core-header__container">
                        ...
                        <div class="core-header__heading">
                            ...
                            <p class="core-header__subtitle lsvr-secondary-font">
                               مرحبا بكم في شجرة عائلة القولداب
        ...
        <div class="core-header__bg core-header__bg--loading">
            ...
            <div class="core-header__bg-image" style="background-image: url( {{ asset('files/nenad-radojcic-Ukld9OZp6cI-unsplash.jpg') }} );background-size: contain;">
                <img src="asset('files/nenad-radojcic-Ukld9OZp6cI-unsplash.jpg') }}" class="core-header__bg-img" aria-hidden="true" alt="">
